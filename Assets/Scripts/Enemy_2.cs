...
public class Enemy_2 : MonoBehaviour{
    ...
    [Header("Logika Pengejaran")]
    public float attackRangeRadius = 6f;
    // PERBAIKAN: Diperkecil agar Skeleton berjalan mendekati Player
    public float retrieveDistance = 1.2f; 
    public LayerMask whatIsPlayer;
    public Transform player;

    [Header("Serangan Jarak Dekat (Melee)")]
    public Transform attackPoint;             // Slot baru untuk titik tebas pedang
    public float attackRangeRadiusVisual = 1f; // Jangkauan tebas pedang
    ...
    // PERBAIKAN UTAMA: Mengganti instansiasi panah menjadi deteksi pukulan jarak dekat
    public void Attack(){
    ...
    private void OnDrawGizmosSelected(){
        ...
        // Memunculkan lingkaran merah untuk mempermudah pengaturan jarak pukul di Inspector
        if (attackPoint != null) {
